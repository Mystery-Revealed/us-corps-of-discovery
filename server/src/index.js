...
app.get('/healthz', (_req, res) =>
  res.json({ ok: true, service: 'us-corps-of-discovery', liveSessions: manager.registry.sessions.size }));
...
server.listen(config.port, () => {
  console.log(`[us-corps-of-discovery] listening on :${config.port} — sessions live in memory only`);
});
